...
These screenshots are intentionally limited to the evidence needed to review
the assessment. Internal prompts, planning notes, transient failures, and
duplicate captures are not included.

| Number | File | Demonstrates |
|---:|---|---|
